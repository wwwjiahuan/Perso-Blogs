	...
	<body>
		<div id='wrapper'>
			...
			<div id='main'>
				<div class="container">
					<div id='picture'>
						<div id="pitHead"><img src="/xiangmu/Blogs/Public/Images/blog.png" alt="图片1"></div>
						<div id="pitBody">
							<img class="one" src="/xiangmu/Blogs/Public/Images/login.jpg" alt="图片2">
					...
					<div id='page'>
						...
						<div id="switch_header">
							<a id = "swileft" href="javascript:void(0)" hidefocus="true">账户登录 <img src="/xiangmu/Blogs/Public/Images/duihao.png"></a>
							<a id = 'swiright' href='/xiangmu/Blogs/index.php/Home/Register/register' target='_top'>注册</a>
