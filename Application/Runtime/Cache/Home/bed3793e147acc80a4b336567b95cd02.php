					...
					<div id='content'>
						<div id='content_box'>
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><p class='title'><!-- <span>题目:</span> --><?php echo ($vo["title"]); ?>
								...
								<!-- <p class='function'>
									<a href="/xiangmu/Blogs/index.php/Home/First/update?id=<?php echo ($vo["id"]); ?>" class='update'>update</a>
									<a href="/xiangmu/Blogs/index.php/Home/First/delete?id=<?php echo ($vo["id"]); ?>" class='delete'>delete</a>
								</p> -->
