				...
				<div class="container">
					...
					<div id='page'>
						...
						<div id="switch_header">
							<a id = "swileft" href="javascript:void(0)" hidefocus="true">账户注册 <img src="/xiangmu/Blogs/Public/Images/duihao.png"></a>
							<a id = 'swiright' href='/xiangmu/Blogs/index.php/Home/Login/login' target='_top'>登陆</a>
						</div>
