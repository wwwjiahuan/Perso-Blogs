...
<html>
	...
	<link rel="stylesheet" type="text/css" href="/xiangmu/Blogs/Public/Css/hottopic.css">
	<body>
		<div id='wrapper'>
				...
				<div id='main'>
					...
					<div id='content'>	
						<article class="post">				
							<div class="hover">	
								<div class="postimage">
									<img src="/xiangmu/Blogs/Public/Images/post1.jpg">
						...
						<article class="post">				
							<div class="hover">	
								<div class="postimage">
									<img src="/xiangmu/Blogs/Public/Images/post2.jpg">
									<!-- <div class="posthover"><a class="openpost" href="javascript:void(0);" data-id="2">read more</a></div> -->
								</div>
								<div class="postinfo">
									<p></p>
						...
						<article class="post">				
							<div class="hover">	
								<div class="postimage">
									<img src="/xiangmu/Blogs/Public/Images/post3.jpg">
									<!-- <div class="posthover"><a class="openpost" href="javascript:void(0);" data-id="2">read more</a></div> -->
								</div>
								<div class="postinfo">
									<p></p>
